...
### Dashboard
![Dashboard](/images/stories/guacamole/dashboard.webp)
The dashboard allows you to quickly access your last session and find any connection that you want to use.

![Active Sessions](/images/stories/guacamole/active-sessions.webp)
...
![File Transfer](/images/stories/guacamole/file-transfer.webp)
...
![Typescript Setting](/images/stories/guacamole/typescript-setting.webp)
...
![Typescript Keylog](/images/stories/guacamole/typescript-keylog.webp)
...
![History](/images/stories/guacamole/history.webp)
...
![Screen Recording Setting](/images/stories/guacamole/screen-recording-setting.webp)
...
![Recording Keylog](/images/stories/guacamole/recording-keylog.webp)
...
![Screen Recording](/images/stories/guacamole/screen-recording.webp)
...
![Flare No Network Adapters](/images/stories/guacamole/flare-no-net-adapters.webp)

Without any network interfaces, the VM has no IP address and cannot communicate with anything on the network.

![Flare No IP](/images/stories/guacamole/flare-noip.webp)
...
![Proxmox Edit Config](/images/stories/guacamole/pve-edit-conf.webp)
...
![Flare PVE Config](/images/stories/guacamole/flare-pve-conf.webp)
...
![Flare VNC](/images/stories/guacamole/flare-vnc.webp)
