...
![Creating an MSI Collector](/images/stories/velociraptor/createmsi0.webp)

From here you configure the collector settings. You can choose which artifacts to collect and set the output format.

![MSI Collector Configuration Step 1](/images/stories/velociraptor/create-msi1.webp)

Then select MSI as the output type so it can be easily deployed on Windows machines.

![MSI Collector Configuration Step 2](/images/stories/velociraptor/create-msi2.webp)

Once the build completes, you have an MSI file ready to deploy.

![Created MSI Package](/images/stories/velociraptor/created-msi.webp)
...
![Virtual File System](/images/stories/velociraptor/vfs.webp)
...
![Collecting Files from Client via VFS](/images/stories/velociraptor/vfs-collectFromClient.webp)
...
![List of Available Artifacts](/images/stories/velociraptor/listOfArtifacts.webp)
...
![Generic Client Info Results](/images/stories/velociraptor/genericClientInfo-results.webp)
...
![Process Tree Results](/images/stories/velociraptor/pstree-results.webp)
...
![Process List](/images/stories/velociraptor/pslist.webp)
...
![Netstat Enriched Results](/images/stories/velociraptor/netstat-enriched.webp)
...
![Chrome History Results](/images/stories/velociraptor/chromeHistory-results.webp)
...
![Evidence of Download Results](/images/stories/velociraptor/evidenceOfDownload-results.webp)
...
![RDP Authentication Results](/images/stories/velociraptor/rdpAuth-results.webp)
...
![PowerShell Activity](/images/stories/velociraptor/powershell.webp)
...
![Certutil Usage](/images/stories/velociraptor/certutil.webp)
...
![Cleared Event Logs](/images/stories/velociraptor/clearedEventLogs.webp)
...
![ADS Hunter Results](/images/stories/velociraptor/adsHunter.webp)
...
![Incoming TeamViewer Connections](/images/stories/velociraptor/incoming-teamviewer.webp)
